...
def player(p):
    print("Enter any space from 1-9")
    t=int(input())
    if game[t-1]!=" ":
...
def begin():
    n=2
    print("Press \n1)Player 1='X' and Player 2='O'\n2)Player 1='O' and Player2='X'")
    tr=int(input())
    if tr==1:
        player1='X'
        player2='O'
...
print("The pattern of Tic-Tac-Toe is")   
print("1  |2  |3  ")
print("__ |__ |__ ")
print("4  |5  |6  ")
print("__ |__ |__ ")
